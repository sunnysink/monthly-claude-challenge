...
| Month | Theme | Link |
|---|---|---|
| August 2026 | Made Visible | [`august-made-visible/`](august-made-visible/) |
...
3. **Edit `index.html` at the root.** Copy the `<a class="month">` block, point
...
- **Sparks** are the four free things that open weekly through the month.
